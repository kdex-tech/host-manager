		...
		"inputSchema": map[string]any{
			...
			"properties": map[string]any{
				...
				"delivery": map[string]any{
					...
					"description": "How to deliver the capability. \"bearer\" (default) returns a token. \"url\" returns a bounded-use, credential-less /-/transfer/<handle> download link that honors `uses` (default 1) and requires `target`.",
				},
