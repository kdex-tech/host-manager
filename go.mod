...
replace kdex.dev/crds => github.com/kdex-tech/kdex-crds v0.14.227
...
require (
	...
	github.com/daveshanley/vacuum v0.24.0 // indirect
	...
	github.com/kdex-tech/entitlements/go v0.2.1
